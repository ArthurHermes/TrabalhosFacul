...
public class Main {
    public static void main(String[] args) {
        ...
        Venda venda = new Venda("João Silva", produtos, 10.0, "Dinheiro", Venda.StatusVenda.CONCLUIDA);


        // Criando um objeto Produto
        Date dataValidade = Date.valueOf("2025-12-31");
        Produto produto = new Produto("Arroz", "Arroz tipo 1", 10.0, 100, "Alimento", dataValidade);    


        //Criando um objeto Fornecedor
        Fornecedor fornecedor = new Fornecedor( "Fornecedor 1", "Rua Y, 456", "9876-5432", "fornecedor1@gmail.com", "Arroz, Feijão, Macarrão");
